...
function Landing() {
    ...
    return (
        <div className='flex justify-center items-center w-full h-203.5 bg-[rgb(12,12,12)] flex-col'>
      ...
      <button onClick={() => navigate("/login")} className='bg-white rounded-xl p-3 mt-10 font-semibold'>LOGIN</button>
      <div className='flex justify-around gap-10 mt-10'>
        <div className=' flex flex-col w-110 h-30 bg-[rgb(18,18,18)] border-[rgb(61,60,60)] border rounded-2xl justify-center '>
        ...
        <div className=' flex flex-col w-110 h-30 bg-[rgb(18,18,18)] border-[rgb(61,60,60)] border rounded-2xl  '>
